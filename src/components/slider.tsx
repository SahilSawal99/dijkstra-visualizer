...
const Slider = ({ 
    ...
    return (
        <div className="mx-8 mt-4 select-none">
            <h1 className="text-gray-300 dark:text-gray-300 text-[12px] font-bold text-black dark:text-gray-300">Speed</h1>
            ...
            <table className="w-[180px]">
                <tbody>
                <tr className="text-gray-300 dark:text-gray-300 text-[11px] text-black dark:text-gray-300">
