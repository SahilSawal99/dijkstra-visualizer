        ...
        <div className="text-center">
            <div className="inline-block">
                <button 
                    ...
                    className="py-1 px-6 mt-5 float-left text-gray-700 dark:text-gray-300 italic border border-gray-800 dark:border-gray-700 text-center text-[13px] rounded hover:bg-amber-400 dark:hover:bg-amber-600 dark:bg-gray-800">
                        Select Start Vertex
                </button>
                <span 
                    ref={refs.startPromptRef} 
                    className="p-1 mt-5 float-left text-gray-700 dark:text-gray-300 text-[13px]" 
                    hidden={true}>
                        Select a vertex to <span className="text-green-600 dark:text-green-400">start</span> with.
                </span>
                <span 
                    ref={refs.retryPromptRef} 
                    className="p-1 ml-8 mt-5 float-left text-gray-700 dark:text-gray-300 text-[13px]" 
                    hidden={true}>
                ...
                <button
                    ref={refs.restartRef} 
                    className="py-1 px-6 mt-5 ml-4 float-left text-gray-700 dark:text-gray-300 italic border border-gray-800 dark:border-gray-700 text-center text-[13px] rounded hover:bg-amber-400 dark:hover:bg-amber-600 dark:bg-gray-800" 
                    hidden={true}>
